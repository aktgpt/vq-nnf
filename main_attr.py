...
def main(
    ...
    for i, row in dataset_csv[start_index:].iterrows():
        ...
        template_bbox = (
            row[["template_x", "template_y", "template_w", "template_h"]].values
        ).astype(int)
        query_bbox = (row[["query_x", "query_y", "query_w", "query_h"]].values).astype(int)
        ...
        occlusions.append(occlusion_row)
...
if __name__ == "__main__":
    ...
    # exp_folder = "exps_final/bbs50"
    exp_folder = "exps_final/tlpattr/attr"
                        ...
                        for n_haar_feature in n_haar_features:
                            ...
                            df.to_csv(
                                os.path.join(
                                    ...
                                    f"{dataset_name}_all_time_results_k3s2haar_{n_feature}.csv"
